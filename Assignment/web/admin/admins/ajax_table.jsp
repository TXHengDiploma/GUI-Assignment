	...
	<tbody>
		<% if(admins.size() != 0){ %>
			...
			<tr>
				...
				<td>
					<div class="btn-group">
							<button class="btn btn-secondary" data-ajax-modal="/admin/admins/edit?id=<%= admin.getId() %>"><i class="fa fa-edit"></i></button>
	...
	$(document).on('click', "[data-delete-id]", function(){
		...
		Swal.fire({
			...
			if(result.isConfirmed){
				console.log(id)
				$("#ajax-form").attr("action",`/admin/admins/delete?id=\${id}`);
